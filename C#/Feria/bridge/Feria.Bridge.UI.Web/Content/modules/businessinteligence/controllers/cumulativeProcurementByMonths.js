...
businessInteligenceApp.controller('cumulativeProcurementByMonths', ['$scope', 'reportsService', 'identityService', 'localizationService', 'DTOptionsBuilder', 'DTColumnBuilder', function ($scope, reportsService, identityService, localizationService, DTOptionsBuilder, DTColumnBuilder) {
    ...
    $scope.getReport = function (reportFilters) {
        ...
        var promise = reportsService.getCumulativeProcurementByMonths(reportFilters);
