...
businessInteligenceApp.controller('cumulativeProcurementByPlants', ['$scope', 'reportsService', 'identityService', 'localizationService', 'DTOptionsBuilder', 'DTColumnBuilder', function ($scope, reportsService, identityService, localizationService, DTOptionsBuilder, DTColumnBuilder) {
    ...
    $scope.getReport = function (reportFilters) {
        ...
        var promise = reportsService.getCumulativeProcurementByPlants(reportFilters);
