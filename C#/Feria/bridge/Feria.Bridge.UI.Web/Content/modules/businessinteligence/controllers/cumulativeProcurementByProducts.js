...
businessInteligenceApp.controller('cumulativeProcurementByProducts', ['$scope', 'reportsService', 'identityService', 'localizationService', 'DTOptionsBuilder', 'DTColumnBuilder', function ($scope, reportsService, identityService, localizationService, DTOptionsBuilder, DTColumnBuilder) {

    $scope.retailWholesalePlantTypes = 3;
    $scope.supplierPartnerTypes = 2;
    ...
    $scope.reportColumns = [
        ...
        DTColumnBuilder.newColumn('productClassification').withTitle('Klasifikacija'),
    ...
    $scope.getReport = function (reportFilters) {
        ...
        var promise = reportsService.getCumulativeProcurementByProducts(reportFilters);
