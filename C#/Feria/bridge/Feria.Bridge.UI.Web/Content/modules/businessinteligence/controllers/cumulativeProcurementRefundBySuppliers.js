...
businessInteligenceApp.controller('cumulativeProcurementRefundBySuppliers', ['$scope', 'reportsService', 'identityService', 'localizationService', 'DTOptionsBuilder', 'DTColumnBuilder', function ($scope, reportsService, identityService, localizationService, DTOptionsBuilder, DTColumnBuilder) {
    ...
    $scope.reportColumns = [
        ...
        DTColumnBuilder.newColumn('supplierName').withTitle('Naziv'),
    ...
    $scope.getReport = function (reportFilters) {
        ...
        var promise = reportsService.getCumulativeProcurementRefundBySuppliers(reportFilters);
