...
{
    //Na Description.Html Preko RouteParams.id, dohvaća Id iz tablice muzike i prikazuje ga na Stranici
    $scope.Id = $routeParams.id;
    var b = $http.get('/api/TablicaHitovasApi/GetTablicaHitova/' + $scope.Id).then(function (result) {
