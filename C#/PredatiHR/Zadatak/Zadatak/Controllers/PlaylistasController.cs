...
{
    public class PlaylistasController : ApiController
    {
        private HitoviEntities1 db = new HitoviEntities1();

        // GET: api/Playlistas
        public IQueryable<Playlista> GetPlaylistas()
        {
            return db.Playlistas;
        }
        ...
        [ResponseType(typeof(Playlista))]
        public IHttpActionResult DeletePlaylista(int id)
        {
            Playlista playlista = db.Playlistas.Find(id);
            if (playlista == null)
            {
